...
class BebidasTableSeeder extends Seeder
{
...

    {
        ...
        Bebida::create(['nombre' => 'Coca-Cola', 'litros' => '1.5 litros', 'precio' => 1500, 'imagen' => 'Coca-Cola (1.5 litros).png']);
        ...
        Bebida::create(['nombre' => 'Sprite', 'litros' => '591 ml', 'precio' => 900, 'imagen' => 'Sprite (591 ml).jpg']);
        Bebida::create(['nombre' => 'Sprite', 'litros' => '1.5 litros', 'precio' => 1500, 'imagen' => 'Sprite (1.5 litro).jpg']);
        Bebida::create(['nombre' => 'Sprite', 'litros' => '3 litros', 'precio' => 2500, 'imagen' => 'Sprite (3 litros).jpg']);
        ...
        Bebida::create(['nombre' => 'Agua mineral Cachantún', 'litros' => '1 litro', 'precio' => 900, 'imagen' => 'Agua mineral Cachantún (1 litros).jpg']);
        Bebida::create(['nombre' => 'Agua mineral Cachantún', 'litros' => '1.5 litros', 'precio' => 1000, 'imagen' => 'Agua mineral Cachantún (1.5 litros).jpg']);
        ...
        Bebida::create(['nombre' => 'Agua mineral Vital', 'litros' => '990 ml', 'precio' => 850, 'imagen' => 'Agua mineral Vital (990 ml).jpg']);
        ...
        Bebida::create(['nombre' => 'Jugos Andina', 'litros' => '1.5 litro', 'precio' => 1500, 'imagen' => 'Jugos Andina (1.5 litro).jpg']);
